...
Welcome to my GitHub profile! I'm **Filipe**, a full-stack JavaScript and TypeScript developer focused on both web and mobile development.
...
![Skills](https://skills.syvixor.com/api/icons?i=html,css,sass,js,ts,reactjs,astro)
...
![Skills](https://skills.syvixor.com/api/icons?i=reactnative,expo)
...
![Skills](https://skills.syvixor.com/api/icons?i=node,express,typescript,vercel,jwt,axios)
...
![Skills](https://skills.syvixor.com/api/icons?i=vscode,git,github,npm,eslint,prettier,nodemon,i18next,thunderclient)
...
- **ThunderClient** – A lightweight REST API client extension for VS Code used to test HTTP requests within the editor.
